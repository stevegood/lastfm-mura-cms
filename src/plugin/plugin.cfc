<cfcomponent>
	...
	<cffunction name="updateMySQL" access="private" output="false" returntype="void">
		
	</cffunction>
	
	<cffunction name="updateMSSQL" access="private" output="false" returntype="void">
	</cffunction>
	
	<cffunction name="delete" returntype="void" access="public" output="false">
		<cfquery datasource="#variables.datasource#">
		DROP TABLE lastfm_config
		</cfquery>
	</cffunction>
